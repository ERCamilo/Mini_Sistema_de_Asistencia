...
test('dialog keyboard behavior closes on Escape and cycles Tab focus', () => {
  assert.deepEqual(getDialogKeyboardAction('Escape', false, 1, 3), { type: 'close' });
  assert.deepEqual(getDialogKeyboardAction('Tab', false, 2, 3), { type: 'focus', index: 0 });
  assert.deepEqual(getDialogKeyboardAction('Tab', true, 0, 3), { type: 'focus', index: 2 });
  assert.deepEqual(getDialogKeyboardAction('Tab', false, 1, 3), { type: 'focus', index: 2 });
});
